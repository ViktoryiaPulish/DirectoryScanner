...
public class ScannerTests
{
    ...
    {
        var fakePath = @"C:\ThisFolderDefinitelyDoesNotExist_12345";
        var scanner = new ScannerService();
    ...
    public async Task ScanAsync_DeeplyNestedDirectoriesWithFewThreads_DoesNotDeadlock()
    {
        ...
        try
        {
            ...
            var completedTask = await Task.WhenAny(scanTask, Task.Delay(5000));

            Assert.True(completedTask == scanTask, "The scan operation deadlocked and did not complete within 5 seconds.");
